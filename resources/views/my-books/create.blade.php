        ...
        <div class="form-card form-card-wide">
            ...
            <form action="{{ route('my-books.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="author" id="author" value="{{ old('author') }}" class="form-control" placeholder="Nama penulis">
                    @error ('author')
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-input" placeholder="Masukkan Judul Buku">
                    @error ('title')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint">Format : JPG, PNG, GIF</div>
                    @error ('cover_image')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
